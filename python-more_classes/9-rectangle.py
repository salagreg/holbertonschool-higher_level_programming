...
class Rectangle:
    ...
    def square(cls, size=0):
        """Create a new Rectangle instance where width and height are equal.

        This class method returns a rectangle that is also a square,
        with both width and height set to the given size.

        Args:
        size (int): The size of both the width and height (default is 0).
