...
def say_my_name(first_name, last_name=""):
    ...
    Paramètres :
        first_name (str) : Le prénom de la personne. Doit être une chaîne de caractères.
        last_name (str, optionnel) : Le nom de famille de la personne. Par défaut : chaîne vide.
